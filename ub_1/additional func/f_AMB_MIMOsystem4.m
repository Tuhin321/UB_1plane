function rotor = f_AMB_MIMOsystem4(Inp,varargin)
...
% decoupling matrices to keep only 1 lateral direction %% quick and dirty
% fix to text with MAGAUD outputs
rotor.sys.A_1dir=Asy(1:2:end,1:2:end); % size(Asy_1dir)
rotor.sys.B_1dir=Bamb(1:2:end,1:2:end); % size(Bamb_1dir)
rotor.sys.C_1dir=C0(1:2:end,1:2:end); % size(Camb_1dir)
rotor.sys.D_1dir=D0(1:2:end,1:2:end); % size(Damb_1dir)
